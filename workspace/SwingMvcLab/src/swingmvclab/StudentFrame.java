...
public class StudentFrame extends JFrame {
    ...
    public StudentFrame() {
        ...
        try {
            ...
            ObjectInputStream ois = new ObjectInputStream(new FileInputStream("GameLeague.dat"));
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                try {
                    ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("GameLeague.dat"));
